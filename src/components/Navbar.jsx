    ...
    <nav className="sticky top-0 z-50 bg-slate-950/80 backdrop-blur-md border-b border-white/5">
      <div className="max-w-7xl mx-auto px-4 h-16 flex justify-between items-center">
        ...
        <Link to="/" className="flex items-center gap-2 group">
            <div className="bg-purple-600 p-1.5 rounded-lg group-hover:-translate-x-1 group-hover:rotate-360 transition-transform">
        ...
        <div className="relative hidden md:block">
            ...
            />
            <Search className="absolute left-3 top-2.5 text-slate-500" size={19} />
        </div>
      </div>
    </nav>
  );
